...
public class MagnetX extends TranslatorBlock {

    public MagnetX(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
        super(blockId, translator, codePrefix, codeSuffix, label);
    }

    public static final String MAGNET_FUNC = "float callMagnetX(MPU9250 &Accel){\n"
            + "  Accel.readSensor();\n"
            + "  return Accel.getMagX_uT();\n"
            + "}";
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        return codePrefix + "callMagnetX(Accel)" + codeSuffix;
    }
}
