 ...
 * @author User
 */
public class AccelerometerX extends TranslatorBlock
{
     ...
     * @param label
     */
    public AccelerometerX (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
    {
     ...
     *
     */
    public static final String ACCEL_FUNC = "float callAccelX(MPU9250 &Accel){\n"
            + "  Accel.readSensor();\n"
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        return codePrefix + "callAccelX(Accel)" + codeSuffix;
    }
}
