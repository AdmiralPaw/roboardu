...
public class RHoverScrollPane extends CScrollPane implements KeyListener {
    ...
    private RHoverVerticalBar verticalbar;
    private RHoverHorizontalBar horizontalbar;
     ...
     */
    public RHoverScrollPane(JComponent view) {
     ...
     * @effects constructs a CScrollPane as described in method overview
     */
    public RHoverScrollPane(JComponent view, ScrollPolicy verticalPolicy, ScrollPolicy horizontalPolicy) {
     ...
     */
    public RHoverScrollPane(JComponent view, int thumbWidth, Color thumbColor, Color trackColor) {
        this(view, ScrollPolicy.VERTICAL_BAR_ALWAYS,
                ScrollPolicy.HORIZONTAL_BAR_ALWAYS,
    ...
    public RHoverScrollPane(
        ...
        verticalbar = new RHoverVerticalBar(thumbWidth, thumbColor, trackColor,
                scrollviewport.getVerticalScrollBar().getModel(), verticalPolicy);
        horizontalbar = new RHoverHorizontalBar(thumbWidth, thumbColor, trackColor,
    ...
    public void repositionComponents() {
        ...
        if (this.vpolicy.equals(ScrollPolicy.VERTICAL_BAR_ALWAYS) || this.vpolicy.equals(ScrollPolicy.VERTICAL_BAR_AS_NEEDED)) {
            verticalbar.setBounds(this.getWidth() - this.thumbWidth, 0,
                    this.thumbWidth, this.getHeight());
        } else {
            verticalbar.setBounds(this.getWidth() - this.thumbWidth, 0,
                    0, 0);
        }
        if (this.hpolicy.equals(ScrollPolicy.HORIZONTAL_BAR_ALWAYS)) {
            horizontalbar.setBounds(0, this.getHeight() - this.thumbWidth,
                    this.getWidth(), this.thumbWidth);
 ...
 *
 */
class RHoverVerticalBar extends JPanel implements MouseListener, MouseMotionListener, MouseWheelListener {
     ...
     */
    public RHoverVerticalBar(int barwidth, Color thumbColor, Color trackColor, BoundedRangeModel modelrange, CScrollPane.ScrollPolicy verticalPolicy) {
        this.vpolicy = verticalPolicy;
...
//            g2.drawRoundRect(0, 0, vWidth, this.getHeight() - 1, vWidth, vWidth);
            ...
            g2.drawRect(0, 0, vWidth, this.getHeight());
 ...
 *
 */
class RHoverHorizontalBar extends JPanel implements MouseListener, MouseMotionListener {
     ...
     * 			with a thumb color set to thummbColor.
     */
    public RHoverHorizontalBar(int barwidth, Color thumbColor, Color trackColor, BoundedRangeModel modelrange) {
        this.modelrange = modelrange;
        this.thumbColor = thumbColor;
        this.trackColor = trackColor;
        this.renderingHints = new RenderingHints(
...
//        g2.drawRoundRect(0, 0, this.getWidth() - 1, vHeight, vHeight, vHeight);
        ...
        g2.setPaint(new Color(193,193,193));
        g2.drawRect(0,0,this.getWidth(),vHeight);
